...
public class costos extends Frame implements ActionListener, WindowListener{  
  //MENU DE COSTOS, incluye el botón de ingredientes, recetas y sub-recetas
...
public static double totali; 
  private double valor2;
   ...
   public costos() throws IOException{ //Crea el menú de costos, donde hay tres opciones: Ingredientes, Recetas y Sub-recetas
   ...
   public void actionPerformed(ActionEvent e) { //invoca el método correspondiente al botón oprimido
       if(e.getSource()== ing)
       ingredientes();     
   ...
   public void recetas(){ //Crea el menú del catálogo de recetas
       drecetas= new JDialog();
       drecetas.setSize(540,390);
       drecetas.setTitle("Menú de recetas");
    ...
    rbotones=new Panel (new GridLayout(4,3,1,1));    
        //Crea todos los botones del catálogo de recetas
   ...
   public void subrecetas(){ //Crea el menú de sub-recetas
       dsubrecetas= new JDialog();
       dsubrecetas.setSize(540,390);
       dsubrecetas.setTitle("Menú de sub-recetas");
   ...
   public void ingredientes(){ //Pantalla donde muestra una tabla con los ingredientes y sus costos
    ...
    String[] data7 = {"Jamón", "1 kg", "20.30", "100%", "20.30"};
    String[] data8 = {"Pasta", "1 kg", "42.73", "100%", "42.73"};
    String[] data9 = {"Limón", "1 kg", "13.95", "98%", "13.67"};
   ...
   //Los siguientes métodos crean las pantallas de cada sub-receta *SOLO TIENEN DATOS LA 1 Y 2*
    ...
    Object[][] data = {{"Pan Francés","1 pz","$2.20"},{"Pimienta","2 gr","$0.70"},{"","",""},{"","Total","$2.90",}, };
   ...
   public void subreceta3(){
    ...
    Object[][] data = {{"Limón", "1 kg", "13.95"}, {"Agua","5 l", "30.00"}, {"","Total","$43.95"}};       //DATOS INVENTADOS PARA EL EJEMPLO
     Object[] nombres = {"Ingrediente","Cantidad","Costo"};    
     table = new JTable(data, nombres);
     table.getTableHeader().setFont(new Font("Serif", 1, 16)); 
     table.getTableHeader().setBackground(Color.black); 
   ...
   public void receta1(){
    ...
    Object[][] data = {{"Baguette","2 pzas","$5.80"},{"Jamón","30 gr","$1.50"},{"Tomate","50 gr","$0.42"},{"Aguacate","30 gr","$0.22"},
